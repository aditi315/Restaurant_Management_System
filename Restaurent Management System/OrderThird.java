...
public class OrderThird extends JFrame implements ActionListener
{
	...
	public OrderThird(String userId)
	{
		super("Third Order");
		...
		title = new JLabel("Third Order Details");
	...
	public int orderQuantity()
	{
        ...
        try
		{
				...
				while(rs.next())
			{
				...
				if(s.equals("not done")&&nm.equals("Chicken Burger")&&id==3&&tempcount==0)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Beef Burger")&&id==3&&tempcount==1)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Peperoni Pizza")&&id==3&&tempcount==2)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Cheese Pizza")&&id==3&&tempcount==3)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Sandwich")&&id==3&&tempcount==4)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Set Menu 01")&&id==3&&tempcount==8)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Set Menu 02")&&id==3&&tempcount==9)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Coke")&&id==3&&tempcount==05)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Coffee")&&id==3&&tempcount==6)
				{
					q=quantity;
					break;
				}
				else if(s.equals("not done")&&nm.equals("Water")&&id==3&&tempcount==7)
				{
					q=quantity;
					break;
				}
	...
	public void orderDone()
	{
        ...
        try
		{
			...
			while(rs.next())
			{
				...
				if(s.equals("not done")&&nm.equals("Chicken Burger")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Beef Burger")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Peperoni Pizza")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Cheese Pizza")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Sandwich")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Set Menu 01")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Set Menu 02")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Coke")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Coffee")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
					
				}
				else if(s.equals("not done")&&nm.equals("Water")&&id==3)
				{
					query2= "UPDATE `order food` SET `status`='done' WHERE `id`=3;";
					st.executeUpdate(query2);
