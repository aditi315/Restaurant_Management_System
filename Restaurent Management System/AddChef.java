...
public class AddChef extends JFrame implements ActionListener{
	...
	public AddChef(String userId)
	{
		super("Restaurant Management System - Add New Employee-addChef");
	...
	public void insertIntoDB()
	{
		...
		String query1 = "INSERT INTO chef VALUES ('"+newId+"','"+eName+"','"+ address+"',"+salary+","+status+");";
