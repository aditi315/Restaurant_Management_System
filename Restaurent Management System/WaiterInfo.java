...
public class WaiterInfo extends JFrame implements ActionListener
{
	JLabel title, nameLabel,userLabel, addressLabel, salaryLabel;
	JTextField nameTF,userTF, addressTF, salaryTF;
	JButton logoutBtn,backBtn;
	JPanel panel;
	String userId;
	
	public WaiterInfo(String userId)
	{
		super("Waiter Information");
	...
	public void displayinfo(String userId)
	{
		...
		String query = "SELECT `userId`, `name`, `address`, `salary` FROM `waiter`;";     
